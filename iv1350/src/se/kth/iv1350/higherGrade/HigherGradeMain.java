...
public class HigherGradeMain {
    public static void main(String[] args) {
        ...
        System.out.println("D" + diceInheritance.getSides() + " throw using inheritance (our favorite): ");
        System.out.println(diceInheritance.rollDice());
        System.out.println(diceInheritance.rollDice());
        System.out.println(diceInheritance.rollDice());

        DiceComposition diceComposition = new DiceComposition(6);
        System.out.println("D" + diceComposition.getSides() + " throw using composition (hate this one (our favorite)): ");
